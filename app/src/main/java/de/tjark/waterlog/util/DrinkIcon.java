...
public enum DrinkIcon {
    ...
    WATER(IconLoader.WATER_ICON_1_LARGE, IconLoader.WATER_ICON_1_SMALL),
    COFFEE(IconLoader.COFFEE_ICON_1_LARGE, IconLoader.COFFEE_ICON_1_SMALL),
    ...
    MILK(IconLoader.MILK_ICON_1_LARGE, IconLoader.MILK_ICON_1_SMALL),
